## Mobile Game Product Analysis Report 

#### Student ID: 22B030594 
#### Date: 3.12.2025 


#### Analysis - Diagrams: 

##### funnel_analysis_22B030594 
![Screenshot](funnel_analysis_22B030594.png) 

##### monetization_analysis_22B030594 
![Screenshot](monetization_analysis_22B030594.png) 

##### retention_heatmap_22B030594 
![Screenshot](retention_heatmap_22B030594.png) 

##### analysis_summary_22B030594.txt 
```
...
• Stickiness: 1.67%  
• Average Session Length: approx. 20 minutes 
...
• Improve Monetization: Introduce better-priced bundles, limited-time offers, and progression-based rewards 
• Improve Experimentation: Ensure A/B tests are statistically powered and test one variable at a time 
• Optimize UA: Do not scale user acquisition until LTV increases, as current LTV:CAC = 0.24× is unprofitable 
